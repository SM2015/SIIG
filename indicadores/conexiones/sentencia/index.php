...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
<title>Sentencias de consulta de Datos</title>
	...
	<body>
		...
		<?php 
			...
			switch ($accion) {
				...
				default:
		?>
					<h2 align="center"><a href="index.php?action=nuevo" title="Agregar una Sentencia SQL">Agregar una Sentencia SQL</a></h2>
		<?php	
					$data = array('Editar','Borrar');
					$urls = array('Editar','Borrar');
					echo listarTodos('sentencia', $data, $urls, 'id_conexion as ID, nombre_conexion as NombreConexion,id_motor as Motor, ip, nombre_base_datos ,comentario as Comentario');
				break;
			}
		?>
	</body>
