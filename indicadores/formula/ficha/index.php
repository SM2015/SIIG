...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script language="JavaScript1.5" type="text/javascript" src="../../addons/chromemenu/chromejs/chrome.js"></script>
        <link rel="stylesheet" type="text/css" href="../../../yui1/build/slider/assets/skins/sam/slider.css" />
	...
	<table  border="0" cellpadding="2" cellspacing="0" class="dataTable" width="100%">
        ...
        switch ($accion) {
            ...
            case 'borrar':
                ...
                break;
                default: ?>
                        <h2 align="center"><a href="index.php?action=nuevo" title="Agregar una Ficha Tecnica de Indicador">Agregar una Ficha Tecnica de Indicador</a></h2>	<?php
                        $data = array('Editar','Borrar','Imprimir');
                        $urls = array('Editar','Borrar','Imprimir');
                        echo listarTodos('ficha_tecnica', $data, $urls, 'id_ficha_tecnica, nombre, tema, concepto, objetivo, uso, definicion_operativa, formula');
                break;
        }?>
    </body>
</html>
