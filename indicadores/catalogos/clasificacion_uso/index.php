...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Clasificacion del Indicador segun su Uso</title>
	...
	<table  border="0" cellpadding="2" cellspacing="0" class="dataTable" width="100%">
        ...
        switch ($accion) {
                ...
                break;
                default: ?>
                        <h2 align="center"><a href="index.php?action=nuevo" title="Agregar una Clasificacion segun su Uso">Agregar una Clasificacion segun su Uso</a></h2>	<?php
                        $data = array('Editar','Borrar');
                        $urls = array('Editar','Borrar');
                        echo listarTodos('clasificacion_uso', $data, $urls, 'id_clasificacion_uso, descripcion');
                break;
        }?>
    </body>
</html>
