...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>Catalogo Fuente de Datos</title>
	...
	<table  border="0" cellpadding="2" cellspacing="0" class="dataTable" width="100%">
        ...
        switch ($accion) {
                ...
                break;
                default: ?>
                        <h2 align="center"><a href="index.php?action=nuevo" title="Agregar Fuente de Datos">Agregar Fuente de Datos</a></h2>	<?php
                        $data = array('Editar','Borrar');
                        $urls = array('Editar','Borrar');
                        echo listarTodos('fuente_dato', $data, $urls, 'id_fuente_dato, nombre, contacto, correo, telefono, cargo');
                break;
        }?>
    </body>
</html>
