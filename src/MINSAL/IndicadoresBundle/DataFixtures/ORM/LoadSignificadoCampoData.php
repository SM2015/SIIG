...
class LoadSignificadoCampoData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $datos[12]['campos'] = array('Codigo'=>'id_genero','Descripcion'=>'Identificador género');                
        $datos[13]['campos'] = array('Codigo'=>'id_establecimiento','Descripcion'=>'Identificador establecimiento');        
        $datos[14]['campos'] = array('Codigo'=>'id_municipio','Descripcion'=>'Identificador municipio');        
        $datos[15]['campos'] = array('Codigo'=>'id_area','Descripcion'=>'Identificador Área');
        $datos[16]['campos'] = array('Codigo'=>'id_departamento','Descripcion'=>'Identificador departamento');        
        $datos[17]['campos'] = array('Codigo'=>'id_region','Descripcion'=>'Identificador región');        
        $datos[18]['campos'] = array('Codigo'=>'id_mes','Descripcion'=>'Identificador mes');                
        
        $datos[19]['campos'] = array('Codigo'=>'pk','Descripcion'=>'Clave primaria', 'UsoEnCatalogo'=>true);
        $datos[20]['campos'] = array('Codigo'=>'fk','Descripcion'=>'Clave foránea', 'UsoEnCatalogo'=>true);
        $datos[22]['campos'] = array('Codigo'=>'descripcion','Descripcion'=>'Descripción', 'UsoEnCatalogo'=>true);
        $datos[22]['campos'] = array('Codigo'=>'otro','Descripcion'=>'Otro significado', 'UsoEnCatalogo'=>true);
