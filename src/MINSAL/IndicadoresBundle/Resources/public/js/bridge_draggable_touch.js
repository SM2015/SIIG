/*
 * A bridge between iPad, iPhone and Android touch events and jquery draggable, sortable etc. mouse interactions.
 * @author Oleg Slobodskoi  
 */
/iPad|iPhone|iPod|Android/.test(navigator.userAgent) && (function($) {
