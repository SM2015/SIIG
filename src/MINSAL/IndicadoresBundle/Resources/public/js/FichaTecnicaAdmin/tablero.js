$(document).ready(function() {
    ...
    function dibujarGraficoPastel(ubicacion, datos, color_grafico, categoryChoosen) {
        ...
        if (ubicacion == 'graficoPrimario')
            arcs.on("click", function(d, i) {
                actualizarGraficosDependientes(d.data.category, i)
            });
    ...
    function dibujarGraficoColumnas(ubicacion, datos, colorChosen, categoryChoosen) {
        ...
        if (ubicacion == 'graficoPrimario')
            plot.selectAll("rect").on("click", function(d, i) {                
                actualizarGraficosDependientes(d.category, i)
            });
        if (colorChosen == null)
    ...
    function actualizarGraficosDependientes(categoryChoosen, i) {
        /* update bar chart when user selects piece of the pie chart */
        //updateBarChart(dataset[i].category);
        var datos_secundarios = datasetSecundarioChosen(categoryChoosen);
        dibujarGraficoSecundario('pastel', datos_secundarios, color(i), categoryChoosen)
        //updateBarChart(datos_secundarios, color(i));
        updateLineChart(categoryChoosen, color(i));
    ...
    dibujarGraficoPrincipal('columnas');
    ...
    function dsBarChart() {
        ...
        var firstDatasetBarChart = datasetSecundarioChosen(group);
        ...
        var svg = d3.select("#graficoSecundario")
                .append("svg")
                .attr("width", width + margin.left + margin.right)
                .attr("height", height + margin.top + margin.bottom)
                .attr("id", "barChartPlot")
    ...
    function updateBarChart(group, colorChosen) {
        ...
        var currentDatasetBarChart = datasetSecundarioChosen(group);
        ...
        var svg = d3.select("#graficoSecundario svg");
